...
const Login = ({path = "/login"}) =>{
    ...
    return (
        <div>
                <Navigation active={"Login"}></Navigation>
                    ...
                    <div className="col-8">
                        {
                            localStorage.getItem("accessToken") ?
                                <>
                                    <h3>Welcome to quizzes</h3>
                                </>
                                :
                                <div className="d-flex justify-content-center align-items-center vh-100">
                                <div className="d-flex flex-column justify-content-center align-items-center w-50">
                                    <p className="text-center">You have to be logged in to continue</p>
                                    <hr className="w-100" style={{height: "5px"}}/>
                                    <a role="button" tabIndex="0"
                                       onClick={loginWithGithub}
                                       className="w-100 btn btn-dark">
                                        <svg stroke="currentColor" fill="currentColor" strokeWidth="0"
                                             viewBox="0 0 16 16" color="white" height="1em" width="1em"
