...
const GenerateQuizEmbedded = ({
  ...
  useEffect(() => {
    ...
    axios.post(backendUrl + `new-quiz-template-check`, quiz).then(response => {
  ...
  const generateQuiz = () => {
    ...
    axios.put(backendUrl + `new-quiz-student`, updatedData).then(async response => {
